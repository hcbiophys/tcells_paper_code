...
# zm_3_5_1
mat_filename_run2  = '../../good_seg_data_3/ZeissLLS_4/20211112_OT1GFP in collagen-04-deskewed_3_Export_Multi_Surf.mat'
coeffPathFormat_run2  = '../../run_series/run2/coeffs/{}_{{}}_pp_surf_SPHARM.txt'.format(1, 1)
zoomedVoxelsPathFormat_run2  = '../../run_series/run2/zoomedVoxels_dist0.5/{}_{{}}.nii.gz'.format(1, 1)
...
zoomedVoxelsPathFormat_stop1 = '../../stop_series/stop1/c/zoomedVoxels_dist0.5/{}_{{}}.nii.gz'.format(1)
...
zoomedVoxelsPathFormat_stop2 = '../../stop_series/stop2/zoomedVoxels_dist0.5/{}_{{}}.nii.gz'.format(0)
...
zoomedVoxelsPathFormat_stop3 = '../../stop_series/stop3/zoomedVoxels_dist0.5/{}_{{}}.nii.gz'.format(3)
...
stack_attributes_stereotypical = [('zm_3_3_5', mat_filename_run1, coeffPathFormat_run1,  (0.5, 0.5, 0.5), (0.8, 0.1, 0.7), 4.166),
                                    ('zm_3_5_1', mat_filename_run2, coeffPathFormat_run2,  (0.5, 0.5, 0.5), (0, 0, 0.3), 4.166),
