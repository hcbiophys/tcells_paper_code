...
class Consecutive_Frames():
    ...
    def add(self, frame, pca0, pca1, pca2, speed_uropod, speed_uropod_running_mean, turning):
    ...
    def interpolate(self):
        ...
        for attribute in ['pca0_list', 'pca1_list', 'pca2_list', 'speed_uropod_list', 'speed_uropod_running_mean_list', 'turning_list']:
